...
xhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById("latest-commit-sha").innerHTML = '<a href=https://github.com/axelgreavette/axelgreavette.xyz/commit/' + sha + '>' + sha + '</a>'
    document.getElementById("latest-commit-date").innerHTML = date
  }  
}
